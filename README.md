...
A minimal read-only page projects three publications, 42 cohorts, and 183
sheet-assets across 27 checked workbook byte identities. It
...
The foreground server derives these 183 allowlisted views
