...
families, and 430 numbered worksheets (94/102/116/118). Six reviewed clusters
register 126 worksheet-assets across 53 classification-aware cohorts. They keep
ANZSOC 2011, preliminary ANZSOC 2023, ANZSOC 2023, concorded historical series,
and experimental FDV namespaces explicit; 304 worksheets remain pending
semantic contracts. The newest six-worksheet preliminary ANZSOC 2023 cluster
preserves methods of finalisation, court levels, jurisdiction, sex and age,
Indigenous status, principal sentences, and the publication's explicit
ANZSOC 2023-by-ANZSOC 2011 concordance without collapsing either identity.
...
and 21,268 canonical observations. A third publication adds 126
*Criminal Courts, Australia* worksheet-assets and 174,980 observations,
including the guilty-outcome, sentence, offence, age, duration, sentence-length,
fine-amount, Indigenous-status, youth, and preliminary-classification clusters.
The combined 255-worksheet batch contains 230,997 canonical observations with
...
measures and contributes 900. The status dashboard now exposes 280 deterministic
per-asset CSV routes and 244,280 canonical observations. Table 27
...
A minimal read-only page projects three publications, 85 cohorts, and 280
sheet-assets across 39 checked workbook byte identities. It
...
The foreground server derives these 280 allowlisted views
