...
import { projectCandidateRangeHints } from "@/lib/llm/candidateRangeHints";
import {
  examplesForPromptVariant,
  formatPromptExample,
  resolvePromptVariant,
  schemaSkeletonExample,
} from "@/lib/llm/promptVariants";
import { buildDslRules } from "@/lib/llm/ruleTiers";
import { buildCompactPrepassPromptSection } from "@/lib/ml-prepass/promptHints";
import {
  buildOntologyPromptPayload,
  PUBLICATION_ONTOLOGY_PROMPT_GUIDANCE,
} from "@/lib/ontology/promptHints";
import { compressTableMarkdown } from "@/lib/summary/compressTableMarkdown";
