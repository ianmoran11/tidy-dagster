...
export type HierarchyAggregationContext = {
  ...
  sourceAggregationRule: "sum" | "weighted_mean" | "non_additive" | "last_value" | "unknown";
  targetAggregationRule: "sum" | "weighted_mean" | "non_additive" | "last_value" | "unknown";
};
...
export type TypedHierarchy = {
  id: string;
  version: string;
  type: "calendar" | "fiscal" | "geographic" | "classification" | "publication_custom";
