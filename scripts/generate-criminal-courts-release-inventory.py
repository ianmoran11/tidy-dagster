#!/usr/bin/env python3
"""Generate or byte-check deterministic Criminal Courts custody files."""
...
from tidy_orchestrator.criminal_courts_release import (  # noqa: E402
...
def main() -> int:
    ...
    downloads_path = root / "criminal-courts-release-downloads-v1.json"
    crosswalk_path = root / "criminal-courts-release-family-crosswalk-v1.json"
    ...
    outputs = {
        ...
        root / "criminal-courts-release-source-inventory-v1.json": encoded(inventory),
        root / "criminal-courts-release-family-membership-v1.json": encoded(membership),
    }
