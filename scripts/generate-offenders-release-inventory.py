#!/usr/bin/env python3
"""Generate or byte-check deterministic Offenders release custody files."""
...
from tidy_orchestrator.offenders_release import (  # noqa: E402
...
def main() -> int:
    ...
    downloads_path = root / "offenders-release-downloads-v1.json"
    crosswalk_path = root / "offenders-release-family-crosswalk-v1.json"
    ...
    outputs = {
        ...
        root / "offenders-release-source-inventory-v1.json": encoded(inventory),
        root / "offenders-release-family-membership-v1.json": encoded(membership),
    }
